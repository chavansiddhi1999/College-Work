<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="PracCSharp.aspx.cs" Inherits="PracCSharp" %>


<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">CSharp Practice
</asp:Content>
...
<br /><br />
    <asp:Button ID="Practice" runat="server" Text="Practice" 
        onclick="Practice_Click" CausesValidation="False" />
        </div>
